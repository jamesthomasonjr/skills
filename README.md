...
Live path: a wrapper may prime the parent with catch-me-up / orient-* on the cheap-resolve file list, then invoke `review-changes`. The parent may hold those dumps. Seats still run in fresh contexts: [review-intent](./skills/engineering/review-intent/SKILL.md) + [review-blind](./skills/engineering/review-blind/SKILL.md) + [review-security](./skills/engineering/review-security/SKILL.md), then [review-verify](./skills/engineering/review-verify/SKILL.md) applies `gates.md`. The security playbook is only in the security window.
