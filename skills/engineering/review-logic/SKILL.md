...
name: review-logic
description: >-
  Logic-candidate seat for defect-first review. Use when
...
Logic-candidate seat. Generate **candidates** only. This skill does
...
| “This might be a bug — emit that” | “This might be a bug” with no sink is not a candidate. |
...
| “Audit the whole repo; logic is the codebase” | Comparison only. This seat is not an existing-codebase audit. |
...
- Emitting “this might be a bug” with no sink
