...
description: >-
  Performance-candidate seat for defect-first review. Use when
...
Performance-candidate seat. Generate **candidates** only. This skill does
...
| “Could be slow — emit that” | “Could be slow” with no sink is not a candidate. |
...
| “Audit the whole repo; performance is the codebase” | Comparison only. This seat is not an existing-codebase audit. |
...
- Emitting “could be slow” with no sink
