...
`review-changes` fans out to [review-intent](./review-intent/SKILL.md) + [review-blind](./review-blind/SKILL.md), then [review-verify](./review-verify/SKILL.md) applies `gates.md`. Inspired by [AntJanus/skillbox](https://github.com/AntJanus/skillbox) (verifier impact floor) and [yeameen/claude-code-review-council](https://github.com/yeameen/claude-code-review-council) (blind-context compose).
